...
const MyNetwork = () => {
  ...
  const Navlinks = (
    <>
      <span className="pt-5">
        <span className="font-bold text-md p-4">{t("Account")}</span>
        <li>
          <NavLink
            to="/order-history"
            className={({ isActive }) =>
              isActive
                ...
                : " flex text-lg p-3 items-center gap-2"
            }
          >
            <img className="w-6" src={orderhistoryimg}></img>
            {t("OrderHistory")}
          </NavLink>
        </li>
        <li>
          ...
          >
            <img className="w-6" src={historyimg}></img>{" "}
      ...
      <span className="pt-5">
        <span className="font-bold text-md p-4">{t("Support")}</span>
        <li>
          <NavLink
            to="comingsoon"
            className={({ isActive }) =>
      ...
      <span className="pt-3">
        <span className="font-bold text-md p-4">{t("Language")}</span>
        <li>
          <div className="flex">
            <span>
      ...
      <span className="pt-5">
        <span className="font-bold text-md p-4">{t("Logout")}</span>
        <li>
          <NavLink
            onClick={handleLogout}
            className={({ isActive }) =>
              isActive
                ? "text-red-900 font-bold text-lg flex items-center gap-2"
                : " flex text-lg p-3 items-center gap-2"
            }
          >
  ...
  // ✅ Corrected filtering from `networks`
                      ...
                      <div>
                        <p className="text-lg p-1 flex items-center font-bold leading-none">
                          ...
                          {profile?.is_approved == "approved" && (
                            <img className="w-8" src={verified_logo}></img>
                          )}
                        </p>
